...
async function insertAnnouncementsAndEvents(conn: PoolConnection) {
  const records = [
    ...
    [6110, "Scholarship Drive for Incoming SaCC Students", "The alumni association is collecting pledges for the 2026 scholarship assistance fund.", "2026-05-12", null, "SaCC Alumni Office", "announcement", null, "Alumni Association", image("photo-1523580846011-d3a5bc25702b"), "active", "approved", adminUsers[0].id, adminUsers[0].id, null, "all", null, 0, 184, 82, "2026-04-13 10:30:00"],
